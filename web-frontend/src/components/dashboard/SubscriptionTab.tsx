    ...
    <div className="max-w-3xl space-y-8 animate-in fade-in slide-in-from-bottom-2 duration-500">
      ...
      <section className="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
        <div className="p-6">
          ...
          <div className="relative w-full h-3 bg-gray-100 rounded-full overflow-hidden mb-4">
            <div
              className={`h-full transition-all duration-1000 ease-out rounded-full ${
                isLowTokens ? "bg-orange-500" : "bg-blue-600"
              }`}
          ...
          {isLowTokens && (
            <div className="flex items-center gap-2 text-orange-700 bg-orange-50 p-3 rounded-xl text-sm border border-orange-100">
        ...
        <div className="bg-gray-50 px-6 py-3 border-t border-black/20 flex items-center gap-2">
