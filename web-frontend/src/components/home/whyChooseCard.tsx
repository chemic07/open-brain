...
export default function WhyChooseCard(props: WhyChooseCardProps) {
  return (
    <div className="bg-[#0D1117]/80 backdrop-blur-md max-w-87.5 rounded-3xl flex flex-col justify-center items-center border border-white/10 p-6 transition-all duration-300 hover:border-blue-500/50 hover:shadow-[0_0_30px_rgba(59,130,246,0.2)]">
